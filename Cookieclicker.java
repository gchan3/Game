...
void mouseClicked() {  
  ...
  if(mouseX > 20 && mouseX < 20 + 250 && mouseY > 130 && mouseY < 130 + 75 && cookies >= grandmaCost) {
    ...
    //Buy factory
  if(mouseX > 20 && mouseX < 20 + 250 && mouseY > 130 && mouseY < 210 + 75 && cookies >= factoryCost) {
    cookies = cookies - factoryCost;
    factoryOwned++;
  }
    //Buy mine
  if(mouseX > 20 && mouseX < 20 + 250 && mouseY > 130 && mouseY < 290 + 75 && cookies >= mineCost) {
    cookies = cookies - mineCost;
    mineOwned++;
  }
    //Buy Lab
  if(mouseX > 20 && mouseX < 20 + 250 && mouseY > 130 && mouseY < 370 + 75 && cookies >= labCost) {
    cookies = cookies - labCost;
    labOwned++;  
  }
    //Buy Portal
  if(mouseX > 20 && mouseX < 20 + 250 && mouseY > 130 && mouseY < 450 + 75 && cookies >= portalCost) {
